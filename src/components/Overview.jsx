      ...
      <div className="three-column">
        <a href="#Reading" className="overview-links">
          <div className="reading">
            <h1>Reading</h1>
            <p>
              Every week, our Quarry Lane/GEC volunteers, currently on Thursdays
              from 4:15 to 5:15 PM, read books and stories to young students
              K-5.
            </p>
        ...
        <a href="#Tutoring" className="overview-links">
          <div className="tutoring">
            ...
            <p>
              Every week, our Quarry Lane/GEC volunteers, currently on Thursdays
              from 4:15 to 5:15 PM (combined with reading), tutor kids on
              various subjects & help them out with schoolwork!
            </p>
        ...
        <a href="#Mission" className="overview-links">
          <div className="projects">
            ...
            <p>
              We are always participating in local outreach or partnering with
              other non-profit organizations/ clubs to support our mission of
              empowering education such as ALP!
            </p>
